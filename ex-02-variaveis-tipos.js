...
/* Questão 02 */
export let objetoQualquer = ["Maçã", "Banana", "Abacaxi", "Maracujá"]

/* Questão 03 */
export let valorIndefinido

/* Questão 04 */
export let tartarugasVoamVerdadeOuNao = Infinity + Infinity == 16
...
/* Questão 10 */
export let quinzeMaisCinco = umaFuncao(15, 5)

/* Questão 11 */
export let valorFalso = false

/* Questão 12 */
export let dezMaisQuatro = umaFuncao(10, 4)

/* Questão 13 */
export let nomeDoSeuEstado = "PE"

/* Questão 14 */
export let artistaFavorito = "Toby Fox"

/* Questão 15 */
export let seteVezesSete = 7 ** 2
...
/* Questão 18 */
export let oCeuEhAzulVerdadeOuNao = 2 + 2 === "peixe"
