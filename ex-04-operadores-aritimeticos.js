...
/* Questão 01 */
export const trintaENove = 44 - 10 + 5 //fiz

/* Questão 02 */
export const centoESessentaEUm = (13**2) - 8 //fiz
...
/* Questão 06 */
export const sessentaEQuatro = 2**(2 * 3) //fiz

/* Questão 07 */
export const vinteETres = 18 + (33 % 7) //fiz

/* Questão 08 */
export const dezenove = 38 / 2 //fiz

/* Questão 09 */
export const centoETrinta = (41 * 3) + (21 / 3) //fiz
...
/* Questão 14 */
export const vinteEDois = 11 * 2 //fiz

/* Questão 15 */
export const quarentaEOito = (2 ** 3) * 6 

/* Questão 16 */
export const trintaETres = 66 / 2 //fiz
