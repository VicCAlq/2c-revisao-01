...
export const sessentaEQuatro = 2 ** 6
...
/* Questão 10 */
export const quinze = 30 / 3 * 1.5

export const quinze = 30 / 2

/* Questão 11 */
export const quarentaETres = 86 / (12 / 4)

export const trinta = 6 * 5

/* Questão 13 */
export const sessentaETres = (125 - 5) / 2
...
/* Questão 15 */
export const quarentaEOito = (2 * 3) * 8
...
/* Questão 17 */
export const quarentaECinco = (3 * 2) * 7.5
...
/* Questão 20 */
export const centoEOitentaEQuatro = 23 * (2 ** 3)
